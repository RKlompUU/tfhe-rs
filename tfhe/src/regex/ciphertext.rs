...
use crate::integer::{RadixCiphertextBig, RadixClientKey, ServerKey};
...
pub fn create_trivial_radix(
    ...
    let shortkey = crate::shortint::ServerKey::from(server_key.clone());
    ...
    RadixCiphertextBig::from(vec_res)
}
